...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\himmu\Downloads\Random\Custom_Form\CRM\myenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\himmu\Downloads\Random\Custom_Form\CRM\myenv\Scripts\deactivate.nu'
